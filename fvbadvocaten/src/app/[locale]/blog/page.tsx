...
export async function generateMetadata({
  ...
  const title =
    loc === "en" ? "Blog" : loc === "fr" ? "Blog" : "Blog";
  const description =
    loc === "en"
      ? "Read our latest legal insights and articles."
      : loc === "fr"
        ? "Lisez nos derniers articles et analyses juridiques."
        : "Lees onze laatste juridische inzichten en artikelen.";
