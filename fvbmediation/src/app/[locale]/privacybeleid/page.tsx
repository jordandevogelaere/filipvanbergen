      ...
      <Container>
        ...
        <div className="prose prose-gray mx-auto max-w-3xl">
          ...
          <p>
            ...
            verwerkingen van persoonsgegevens die door FVB Mediation /
            Bemiddeling Filip van Bergen (hierna ook &ldquo;wij&rdquo; of
          ...
          <ul>
            <li>Uitvoering van de bemiddelingsovereenkomst</li>
          ...
          <p>
            ...
            <a href="mailto:info@fvbmediation.com">info@fvbmediation.com</a>.
          </p>
          <h3>6. Cookies</h3>
          ...
          <h3>8. Contact</h3>
          <p>
            FVB Mediation, Lange Leemstraat 55, 2018 Antwerpen –{" "}
            <a href="mailto:info@fvbmediation.com">info@fvbmediation.com</a>
          </p>
        </div>
      </Container>
