      ...
      <Container>
        ...
        <div className="prose prose-gray mx-auto max-w-3xl">
          <ol>
            ...
            <li>
              Iedere aansprakelijkheid is beperkt tot het bedrag waarvoor
              verzekeringsdekking is verworven. De vennootschap is verzekerd via
              de door de Orde van Vlaamse Balies bij Amlin onderschreven
              aansprakelijkheidsverzekering voor maximaal 2.500.000,00 &euro;.
            </li>
            <li>
            ...
            <li>
              Het is de opdrachtgever niet toegelaten de geproduceerde
            ...
            <li>
              ...
              brengt van rechtswege een interest van 1% per maand met zich mee.
            </li>
            <li>
